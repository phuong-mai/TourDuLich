...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
    <form action="cost/edit_cost/{cost_id}" method="POST">
        @csrf
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="inputHospitalFee" name="cost_hotel" value="{{ $data-> cost_hotel }}" pattern="[0-9]*" >
            </div>
            <div class="form-group col-md-6">
            <label for="inputMealFee">Phí ăn uống</label>
            <input type="text" class="form-control" id="inputMealFee" name="cost_food" value="{{ $data-> cost_food }}" pattern="[0-9]*" >
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
            <label for="inputTransportFee">Phí phương tiện</label>
            <input type="text" class="form-control" id="inputTransportFee" name="cost_vehicle" value="{{ $data-> cost_vehicle }}" pattern="[0-9]*">
            </div>
            <div class="form-group col-md-6">
            <label for="inputOtherFee">Phí khác</label>
            <input type="text" class="form-control" id="inputOtherFee" name="another" value="{{ $data-> cost_another }}" pattern="[0-9]*">
            </div>
        </div>
        <div class="form-group">
