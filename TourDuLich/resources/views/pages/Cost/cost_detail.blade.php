  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="row justify-content-between">
        <div class="col-auto">
            <h5 class="font-weight-bold text-primary">Chi tiết chi phí</h5>
        </div>
      </div>
    </div>
    <div class="card-body">
    <form>
        <div class="form-group">
            ...
            <textarea class="form-control" id="cost_detail" name="cost_detail" rows="5">{{ $show->cost_detail }}</textarea>
            </div>
        </div>
