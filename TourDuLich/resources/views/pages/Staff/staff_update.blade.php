...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
    <form action="staff/edit_staff/{$staff->staff_id}" onsubmit="return validation()" method="post">
        @csrf
       ...
       <label for="inputGroup">Họ và tên</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" value="{{$staff->staff_phone_number}}"  class="form-control" id="staff_phone_number" name="staff_phone_number" >
        ...
        <div class="form-row">
            ...
            <input type="text" value="{{$staff->staff_id_card}}" class="form-control" id="staff_id_card" name="staff_id_card">
