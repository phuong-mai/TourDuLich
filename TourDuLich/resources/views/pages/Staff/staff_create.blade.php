      ...
      @csrf
        ...
        <div class="form-row">
            ...
            @if ($errors->has('staff_phone_number'))
              ...
              <input type="text" class="form-control" id="staff_phone_number" name="staff_phone_number" pattern="[0-9]*">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="staff_id_card" name="staff_id_card" pattern="[0-9]*">
            </div>
            <div class="form-group col-md-6">
